  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <motion.nav
        ...
        className="bg-[#1E2A49] text-white px-4 py-4 shadow-lg fixed top-0 left-0 w-full z-50"
      >
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden bg-[#1E2A49] absolute top-16 left-0 w-full py-6 shadow-lg"
            >
